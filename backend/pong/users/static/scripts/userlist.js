            ...
            div.innerHTML = /*html*/ `
                ...
                <div class="all-users">
                    ${filteredData.map(user => {
                        ...
                        return `
                            <div class="player">
                                <img onclick="userProfile('${user.username}'); navigateTo('#userProfile');" src="${avatarUrl}" alt="${user.username}'s avatar">
                                <span class="player-name">${formatPlayerName(user.username)}</span>
                                <span onclick="userProfile('${user.username}'); navigateTo('#userProfile');" class="badge text-bg-warning">View Profile</span>
                                <span id="chat-from-userlist" class="badge text-bg-light" onclick="chatPage(); startChat('${user.username}', '${avatarUrl}'); navigateTo('#chatPage');">
