            ...
            div.innerHTML = `
                ...
                <div class="all-users">
                    ${filteredData.map(user => {
                        ...
                        return `
                            <div class="player">
                                <img onclick="userProfile('${player.name}'); navigateTo('#userProfile');" src="${avatarUrl}" alt="${user.username}'s avatar">
                                <span class="player-name">${formatPlayerName(user.username)}</span>
                                <span onclick="userProfile('${player.name}'); navigateTo('#userProfile');" class="badge text-bg-warning">View Profile</span>
